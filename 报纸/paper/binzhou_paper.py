...
headers = {
    ...
    # 'Cookie': 'acw_tc=1a0c651f17272527909211020e0033a066a3f7650aae674cb9e691862da8fb; JSESSIONID=686CEB8311DB62EE212B052E96AE1EB3',
    'Pragma': 'no-cache',
...
def get_binzhou_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m%d')
    base_url = f'http://paper.bzrb.net/bzrb/{paper_time}/html/'
...
# get_binzhou_paper('2020-09-22', 111, 1111)
