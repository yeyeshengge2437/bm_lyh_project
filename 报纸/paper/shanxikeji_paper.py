...
headers = {
    ...
    # 'Cookie': 'JSESSIONID=2383C81DCA55703370BC8EB021528398.work1',
    'Pragma': 'no-cache',
...
def get_shanxikeji_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m%d')
    base_url = f'https://szb.snkjb.com/sxkjb/{paper_time}/html/'
...
# get_shanxikeji_paper('2024-10-11', 111, 1111)
