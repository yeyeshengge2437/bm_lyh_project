...
def get_chaidamu_paper_new(paper_time, queue_id, webpage_id):
    ...
    base_url = f'https://www.cdmrb.com.cn/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://www.cdmrb.com.cn/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
def get_chaidamu_paper_old(paper_time, queue_id, webpage_id):
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            bm_html = etree.HTML(bm_content)
            # 版面的pdf
            bm_pdf = 'https://www.cdmrb.com.cn/html/' + "".join(bm_html.xpath("//td[4]/a/@href")).strip('../..')

            # 获取所有文章的链接
            all_article = bm_html.xpath("//tr[4]/td/div/table/tbody/tr/td[@class='default'][2]/a")
            pdf_set = set()
            for article in all_article:
                # 获取文章链接
...
# get_chaidamu_paper('2017-06-15', 111, 1111)
# get_chaidamu_paper_old('2017-06-30', 111, 222)
