...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'http://epaper.sxycrb.com/wbpaper/pc/layout/202409/19/node_01.html',
...
def get_yuncheng_lastpaper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'http://epaper.sxycrb.com/wbpaper/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'http://epaper.sxycrb.com/wbpaper/pc/' + "".join(bm.xpath("./a[2]/@href")).strip('../../..')
            # 获取版面详情
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'http://epaper.sxycrb.com/wbpaper/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_yuncheng_lastpaper('2024-08-22', 111, 1111)
