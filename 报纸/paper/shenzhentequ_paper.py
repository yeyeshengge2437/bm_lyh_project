...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_d831baa66bbc83c1f8af148ddee67af0=1724982892,1725436126; Hm_lpvt_d831baa66bbc83c1f8af148ddee67af0=1725436126; HMACCOUNT=FDD970C8B3C27398; botindex=0',
    'Pragma': 'no-cache',
    'Referer': 'https://sztqb.sznews.com/PC/layout/index.html',
...
def get_shenzhentequ_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'https://sztqb.sznews.com/PC/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://sztqb.sznews.com/' + "".join(
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://sztqb.sznews.com/PC/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_shenzhentequ_paper('2022-04-06', 111, 1111)
