...
headers = {
    ...
    # 'Cookie': 'HWWAFSESID=0910c795181e88a3ee; HWWAFSESTIME=1728877033616',
    'Pragma': 'no-cache',
...
def get_chengdu_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'https://www.cdrb.com.cn/epaper/cdrbpc/{paper_time}/'
    url = base_url + 'l01.html'
...
# get_chengdu_paper('2024-02-28', 111, 1111)
