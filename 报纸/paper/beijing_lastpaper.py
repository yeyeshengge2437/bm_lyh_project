...
def get_beijing_lastpaper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    ...
    pdf_base_url = f'https://bjrbdzb.bjd.com.cn/bjwb/mobile/{pdf_base}'
    # base_url = f'https://bjrbdzb.bjd.com.cn/bjrb/mobile/{paper_time}_m.html'
    base_url = f'https://bjrbdzb.bjd.com.cn/bjwb/mobile/{paper_time}_m.html'
    url = base_url + '#page0'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            page_num = str(int(''.join(bm.xpath("./a/@data-source"))) + 1)
            # 版面链接
...
# get_beijing_lastpaper('2024-08-22', 111, 1111)
