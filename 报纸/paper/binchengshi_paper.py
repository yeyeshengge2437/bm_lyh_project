...
headers = {
    ...
    # 'Cookie': '127_vq=1; route=4acb0b4a4a0a37e1f4eadede94841720',
    'Pragma': 'no-cache',
...
def get_chuxiong_paper(paper_time, queue_id, webpage_id):
    ...
    base_url = f'http://www.tjbh.com/szb/pages/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        # 获取所有版面的的链接
        all_bm = html_1.xpath("//ul[@class='nav nav-pills']/li/a")
        for bm in all_bm:
            # 版面名称
