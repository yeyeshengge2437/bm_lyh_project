...
headers = {
    ...
    # 'Cookie': 'JSESSIONID=4980BBE2B83FDB68C35130042EE4573C',
    'Pragma': 'no-cache',
...
def get_shanxinongcun_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m%d')
    base_url = f'https://sxncb.joyhua.cn/sxncb/{paper_time}/html/'
