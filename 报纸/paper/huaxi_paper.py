...
def get_huaxi_paper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            for article in all_article:
                ...
                if bm_pdf not in pdf_set and (judging_criteria(article_name, content) or '广告' in article_name) and judge_bm_repeat(paper, bm_url):
                    # 将报纸url上传
