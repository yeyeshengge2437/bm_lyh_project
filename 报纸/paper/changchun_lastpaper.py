...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'http://epaper.changchunews.com/ccwb/pc/paper/layout/',
...
def get_changchun_lastpaper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'http://epaper.changchunews.com/ccwb/pc/paper/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'http://epaper.changchunews.com/ccwb/pc/paper/' + "".join(bm_html.xpath("//div[@class='mgb25']/div[@class='pull-right']/a/@href")).strip('../../..')
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'http://epaper.changchunews.com/ccwb/pc/paper/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
