...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'https://www.chinatradenews.com.cn/epaper/content/2025-01/09/node_2.htm',
...
def get_chuxiong_paper(paper_time, queue_id, webpage_id):
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 获取所有文章的链接
            all_article = bm_html.xpath("//ul[@class='list01']/li/a")
            pdf_set = set()
...
# get_chuxiong_paper('2024-12-26', 111, 1111)
