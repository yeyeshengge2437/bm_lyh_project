...
headers = {
    ...
    # 'Cookie': 'UM_distinctid=19193048ecc60-0d96d2e1ce73b3-26001e51-13c680-19193048ecde23; CNZZDATA1279173235=134189569-1724748435-%7C1725267040',
    'Pragma': 'no-cache',
...
def get_qingdaozao_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
    base_url = f'https://epaper.guanhai.com.cn/conpaper/qdzb/html/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://epaper.guanhai.com.cn/conpaper/qdzb/' + "".join(
...
# get_qingdaozao_paper('2024-09-02', 111, 1111)
