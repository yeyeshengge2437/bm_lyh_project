...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_a41904b47b605babfa11365b7bc6999b=1729236908; Hm_lpvt_a41904b47b605babfa11365b7bc6999b=1729236908; HMACCOUNT=FDD970C8B3C27398',
    'Pragma': 'no-cache',
...
def get_chuxiong_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    ...
    base_url = f'https://www.chinatradenews.com.cn/epaper/content/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://www.chinatradenews.com.cn/epaper/content/' + "".join(bm_html.xpath("//td[@class='sxb2']/a/@href")).strip('../..')

            # 获取所有文章的链接
            all_article = bm_html.xpath("//ul[@class='list01']/li")
            pdf_set = set()
