...
headers = {
    ...
    # 'cookie': 'HWWAFSESID=c39287691cc7f33257; HWWAFSESTIME=1727330729804',
    'pragma': 'no-cache',
    'priority': 'u=0, i',
...
def get_qinzhou_paper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'https://qzrb.gxqzxw.com/pc/column/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://qzrb.gxqzxw.com/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_qinzhou_paper('2021-12-16', 111, 1111)
