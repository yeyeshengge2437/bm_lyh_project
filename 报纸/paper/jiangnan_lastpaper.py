...
headers = {
    ...
    # 'Cookie': 'NSC_WT_GA_TAC=ffffffff09020f3a45525d5f4f58455e445a4a423660',
    'Pragma': 'no-cache',
...
def get_jiangnan_lastpaper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'http://szb.wxrb.com/jnwb/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'http://szb.wxrb.com/jnwb/pc/' + "".join(bm_html.xpath("//div[@class='pull-right']/a/@href")).strip('../../..')
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'http://szb.wxrb.com/jnwb/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_jiangnan_lastpaper('2024-01-06', 111, 1111)
