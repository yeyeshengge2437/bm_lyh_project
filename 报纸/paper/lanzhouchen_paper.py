...
def get_lanzhouchen_paper_new(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
...
def get_lanzhouchen_paper_old(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
...
def get_lanzhouchen_paper(paper_time, queue_id, webpage_id):
    ...
    if paper_time1 <= date_str:
        # print('使用旧方法')
        get_lanzhouchen_paper_old(paper_time, queue_id, webpage_id)
    else:
        # print('使用新方法')
        get_lanzhouchen_paper_new(paper_time, queue_id, webpage_id)


# get_lanzhouchen_paper('2019-02-11', 111, 1111)
