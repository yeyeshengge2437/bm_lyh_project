...
def get_wenzhou_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m-%d')
    data = {
        'digitalNewspaperMark': 'wzrb',
    ...
    if response.status_code == 200:
        ...
        for bm in bm_list:
            ...
            bm_url = f'http://szb.66wz.com/newspaper?mediaKey=wzrb&showArticleDetail=false&curEdition=01&publishTime={paper_time}'
            ...
            if bm_response.status_code == 200:
                ...
                for article in article_list:
                    ...
                    article_url = f"http://szb.66wz.com/newspaper?mediaKey=wzrb&showArticleDetail=true&docId={article_id}&curEdition={article['edition']}&publishTime={paper_time}"
...
# get_wenzhou_paper('2024-10-01', 111, 1111)
