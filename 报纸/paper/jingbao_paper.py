...
def get_jingbao_paper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    # https://jb.sznews.com/PC/layout/202408/30/node_A01.html
    base_url = f'https://jb.sznews.com/PC/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://jb.sznews.com/' + "".join(
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://jb.sznews.com/PC/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_jingbao_paper("2024-08-30", "111", "1111")
