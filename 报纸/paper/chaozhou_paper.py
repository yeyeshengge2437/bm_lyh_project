...
def get_chaozhou_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
    base_url = f'http://www.chaozhoudaily.com/upload/czrb/html/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        # 获取所有版面的的链接
        all_bm = html_1.xpath('//td/div/table/tbody/tr')
        for bm in all_bm:
            # 版面名称
            ...
            # 版面的pdf
            bm_pdf = 'http://www.chaozhoudaily.com/upload/czrb/' + "".join(
            ...
            # 获取所有文章的链接
            all_article = bm_html.xpath("//td[@class='default'][2]/a")
            pdf_set = set()
