...
headers = {
    ...
    'Cookie': 'uid=1728368802373_8718772985; zycna=JwwyRIkbYF0BAXPBuY3dtKaX; Hm_lvt_b4ae0087f7b17481d650cc0a8574f040=1728368802; HMACCOUNT=FDD970C8B3C27398; Hm_lpvt_b4ae0087f7b17481d650cc0a8574f040=1728369090',
    'Pragma': 'no-cache',
...
def get_date():
    date = {}
    response = requests.get('https://jxzx.jxnews.com.cn/ghsb/index.shtml', headers=headers, verify=False)
    if response.status_code == 200:
        content = response.content.decode()
        html = etree.HTML(content)
        dates = html.xpath("//ul/li[@class='xwlb1']")
        for date in dates:
