...
headers = {
    ...
    # 'Cookie': 'clwz_blc_pst_xd0xc2xcexc5=16885952.20480',
    'Pragma': 'no-cache',
...
def get_chinaqingnian_paper(paper_time, queue_id, webpage_id):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
    base_url = f'https://zqb.cyol.com/html/{paper_time}/'
    url = base_url + 'nbs.D110000zgqnb_01.htm'
