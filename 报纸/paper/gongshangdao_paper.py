...
def get_gongshangdao_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
            ...
            for bm in bm_list:
                ...
                for bm_area in bm_areaList:
                    ...
                    if bm_img not in pdf_set and (
                            "分类信息" in article_name or judging_bm_criteria(article_name, bm_url, bm_url_in)) and judge_bm_repeat(paper,
                                                                                                                 bm_url):
                        # 将报纸img上传
