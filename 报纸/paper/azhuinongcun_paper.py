...
def get_anhuinongcun_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://szb.ahnews.com.cn/ncb/pc/' + "".join(
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://szb.ahnews.com.cn/ncb/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_anhuinongcun_paper('2024-09-20', 111, 1111)
