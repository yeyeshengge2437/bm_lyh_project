...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_ddccd98ce59458e89f25e27e6fdbf444=1727055725; Hm_lpvt_ddccd98ce59458e89f25e27e6fdbf444=1727055725; HMACCOUNT=FDD970C8B3C27398',
    'Pragma': 'no-cache',
    'Referer': 'http://epaper.dbcsq.com/html/index.html',
...
def get_haidong_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'http://epaper.dbcsq.com/html/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = "".join(bm_html.xpath("//div[@class='nav-list']/ul/li/a[@class='pdf']/@href")).strip('../..')
...
# get_haidong_paper('2024-08-22', 111, 1111)
