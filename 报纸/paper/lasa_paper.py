...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'http://www.lasaribao.cn/lsrb/pc/layout/index.html',
...
def get_lasa_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'http://www.lasaribao.cn/lsrb/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'http://www.lasaribao.cn/lsrb/pc/' + "".join(bm_html.xpath("//a[@class='pdf']/@href")).strip('../../..')
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'http://www.lasaribao.cn/lsrb/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_lasa_paper('2024-08-22', 111, 1111)
