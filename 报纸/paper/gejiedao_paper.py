...
headers = {
    ...
    # 'Cookie': 'JSESSIONID=32DE7C814C81F77F5044AD635570C752',
    'Pragma': 'no-cache',
    'Referer': 'http://paper.gjnews.cn/',
...
def get_gejiedao_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m%d')
    base_url = f'http://paper.gjnews.cn/gjdb/{paper_time}/html/'
...
# get_gejiedao_paper('2024-10-09', 111, 1111)
