...
def get_hefei_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    # base_url = f'https://newspaper.hf365.com/jhcb/pc/layout/{paper_time}/'
    base_url = f'https://newspaper.hf365.com/hfrb/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://newspaper.hf365.com/hfrb/pc/' + "".join(bm_html.xpath('//*[@id="pdfUrl"]/text()')).strip('../../..')
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://newspaper.hf365.com/hfrb/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_hefei_paper('2024-09-26', 111, 1111)
