...
pdf_domain = 'https://newpaper.dahe.cn/hnrb/'
today = datetime.now().strftime('%Y-%m-%d')


def get_henan_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
    base_url = f'https://newpaper.dahe.cn/hnrb/html/{paper_time}/'
...
# queue_id = 111
# webpage_id = 111
# get_henan_paper("2007-11-01", queue_id, webpage_id)
