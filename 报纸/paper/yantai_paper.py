...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_b8c1ee5eb4da73f0aca18bce66daca3b=1728351064; Hm_lpvt_b8c1ee5eb4da73f0aca18bce66daca3b=1728351064; HMACCOUNT=FDD970C8B3C27398',
    'Pragma': 'no-cache',
...
def get_yantai_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'https://www.shm.com.cn/szb/ytrb/paper/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://www.shm.com.cn/szb/ytrb/paper/pc/' + "".join(
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://www.shm.com.cn/szb/ytrb/paper/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_yantai_paper('2023-10-26', 111, 1111)
