...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'https://www.geermurb.com/',
...
def get_geermu_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y-%m/%d')
    base_url = f'https://www.geermurb.com/html/{paper_time}/'
    url = base_url + 'node_6.htm'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://www.geermurb.com/html/' + "".join(
            ...
            # 获取所有文章的链接
            all_article = bm_html.xpath("//tr/td[@class='default'][2]/a")
            pdf_set = set()
...
# get_geermu_paper('2023-09-11', 111, 1111)