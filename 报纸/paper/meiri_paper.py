...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_a57dca1ce005a70398754307b6ebe677=1723453974; Hm_lpvt_a57dca1ce005a70398754307b6ebe677=1723453974; HMACCOUNT=FDD970C8B3C27398',
    'Pragma': 'no-cache',
...
def get_meiri_paper(paper_time, queue_id, webpage_id):
    ...
    base_url = f'http://epaper.tianjinwe.com/mrxb/html/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        # 获取所有版面的的链接
        all_bm = html_1.xpath("//tr[2]/td/div/table/tbody/tr[@class='bmdh_tr']")
        for bm in all_bm:
            # 版面名称
            ...
            for article in all_article:
                ...
                if bm_pdf not in pdf_set and ("公告" in article_name or judging_criteria(article_name, content) or "广告" in article_name) and judge_bm_repeat(paper, bm_url):
                    # 将报纸url上传
