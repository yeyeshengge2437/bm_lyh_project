...
headers = {
    ...
    # 'Cookie': 'wdcid=72e99bc5846f6f63; wdses=49f7fe8276cf93f6; wdlast=1728618408',
    'Pragma': 'no-cache',
...
def get_anhuikeji_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m%d')
    base_url = f'http://ahkjb.joyhua.cn/ahkjb/{paper_time}/html/'
...
# get_anhuikeji_paper('2024-08-21', 111, 1111)
