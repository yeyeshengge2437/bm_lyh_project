...
headers = {
    ...
    # 'Cookie': 'Hm_lvt_77002c6b9fe15a5136bbe06f933886b8=1724116508,1724319489,1724749918,1725517427; HMACCOUNT=FDD970C8B3C27398; Hm_lpvt_77002c6b9fe15a5136bbe06f933886b8=1725590717',
    'Pragma': 'no-cache',
    'Referer': 'https://epaper.lnd.com.cn/lnfzbpaper/pc/layout/',
...
def get_liaoningfazhi_paper(paper_time, queue_id, webpage_id, bm_url_in=None):
    # 将today的格式进行改变
    day = paper_time
    paper_time = datetime.strptime(paper_time, '%Y-%m-%d').strftime('%Y%m/%d')
    base_url = f'https://epaper.lnd.com.cn/lnfzbpaper/pc/layout/{paper_time}/'
    ...
    if response.status_code == 200:
        ...
        for bm in all_bm:
            ...
            # 版面的pdf
            bm_pdf = 'https://epaper.lnd.com.cn/lnfzbpaper/pc/' + "".join(
            ...
            for article in all_article:
                # 获取文章链接
                article_url = 'https://epaper.lnd.com.cn/lnfzbpaper/pc/' + ''.join(article.xpath("./@href")).strip('../../..')
                # 获取文章名称
...
# get_liaoningfazhi_paper('2024-06-20', 111, 1111)
