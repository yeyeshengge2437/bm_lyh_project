...
test_url = "http://121.43.164.84:29775"
...
if response.status_code == 200:
    ...
    for bm in all_bm:
        ...
        for title in title_urls:
            ...
            # 判断是否包含关键词
            if any(keyword in title_content for keyword in claims_keys):
                have_key = True
                # 上传到数据库
                # 将数据插入到表中
                # 上传到数据库
                ...
                cursor_test.execute(insert_sql,
                                    (bm_url, day, paper, title_name, content, title_url, create_time, create_date))
