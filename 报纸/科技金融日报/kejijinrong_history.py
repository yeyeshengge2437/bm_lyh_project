        ...
        for data in datas:
            ...
            if response.status_code == 200:
                ...
                for bm in all_bm:
                    ...
                    day = f"{year_month_day[0]}-{year_month_day[1]}-{year_month_day[2]}"
                    paper = "科技金融日报"
                    ...
                    for title in title_urls:
                        ...
                        title_unique = title_url.split('?')[0]
                        if title_unique not in title_set:
                            title_set.add(title_unique)
                            # 获取文章内容
                            ...
                            # 获取文章标题
                            title_name = "".join(
                                title_html.xpath("//div[@class='main-article-alltitle']//text()")).strip()
                            # 获取文章内容
                            ...
                            if claims_keys.match(title_name):
                                ...
                                cursor_test.execute(insert_sql,
                                                    (bm_url, day, paper, title_name, content, title_url, create_time,
                                                     create_date))
