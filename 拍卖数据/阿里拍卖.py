                ...
                if status_orders == 6:
                    for info in info_list:
                        ...
                        if "同类商品" not in href_text:
                            ...
                            url, title, disposition_subject, phone, reference_value, recruitment_time, type, process,
                            guarantee_method, total, situation, guarantor, collateral, detail, more_info, supple_mater,
                    ...
                    for info in info_list:
                        ...
                        if "同类商品" not in href_text:
                            ...
                            if now_state and now_state == "已结束":
                                continue
                            if now_state and (now_state == "正在进行中" or now_state == "即将拍卖") and status_orders == 2:
                                flag = True
                            tab_2 = page.new_tab()
                            tab_2.get(href_url)
                            ...
                            if end_time:
                                ...
                                if "结束时间" in end_time:
                                    data_dict["结束时间"] = re.findall(r'(\d{4}/\d{2}/\d{2} \d{2}:\d{2}:\d{2})', end_time)[
                                        0]
