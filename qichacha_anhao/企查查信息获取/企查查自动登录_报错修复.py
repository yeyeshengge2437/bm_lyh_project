...
time.sleep(2)
page.ele(
    "xpath=//input[@class='qccd-input qccd-input-lg qcc-login-quick-login-phone qcc-login-quick-login-password']").input(
    "15938554242")
time.sleep(1)
page.ele("xpath=//input[@class='qccd-input qccd-input-lg']").input("liyongheng10")
page.ele(
