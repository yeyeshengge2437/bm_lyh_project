        ...
        if not (guarantee_new and mortgagor_new and collateral_new):
            ...
            try:
                a, b, guarantee_new = model_name(
                    content, system_content="请从中提取保证人(包含公司和个人,当担保人没有特殊说明时默认为保证人)， 抵押人/质押人(提供质押物/抵押物的公司或个人)，抵押物/质押物信息，单个主体以','分割，不要输出其他无关字段,没有保证人返回'空'，没有抵押人/质押人返回'空'，没有抵押物/质押物返回'空'，严格按照执行。案例：保证人:某某有限公司,李某某,王某某; 抵押人/质押人:某某公司，某某人; 抵押物/质押物:位于某处房产,某工厂;(每项用';'结束)注意：此案例为借鉴数据，请不要引用里面的数据，不要将其他与保证人无关的主体放在保证人里面。")
                print(guarantee_new)
