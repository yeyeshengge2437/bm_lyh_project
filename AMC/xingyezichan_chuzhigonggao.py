...
def get_xinyezichan_chuzhigonggao(queue_id, webpage_id):
    page = ChromiumPage(co)
    page.set.load_mode.none()
    try:
        for count in range(917596318, 917596312 - 1, -1):
            page_url = f'http://www.ciamc.com.cn/ciamc/insetInfo/disposal-Notice.html_{count}.html'
...
# get_xinyezichan_chuzhigonggao(111, 222)
