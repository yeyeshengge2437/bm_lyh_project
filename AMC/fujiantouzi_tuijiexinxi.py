...
from api_paper import get_image, judge_bm_repeat, upload_file, judge_title_repeat

co = ChromiumOptions()
co = co.set_argument('--no-sandbox')
co = co.headless()
co.set_paths(local_port=9217)
...
def fujiantouzi_tuijiexinxi(queue_id, webpage_id):
    ...
    try:
        ...
        while True:
            if count == 0:
                page_url = 'http://www.mtamc.com.cn/zcxx/tjxx/index.htm'
            else:
                page_url = f'http://www.mtamc.com.cn/zcxx/tjxx/index_{count}.htm'
            ...
            for title in title_list:
                ...
                title_url = "http://www.mtamc.com.cn/zcxx/tjxx" + "".join(title.xpath("./a[1]/@href")).strip('.')
...
# fujiantouzi_tuijiexinxi(111, 222)
