...
co = co.headless()
co.set_paths(local_port=9240)


def zhongxinjinrongzhejiang_gzh(queue_id, webpage_id):
    img_set = set()
    name = '中国中信金融资产浙江分公司'
    ...
    for data in data_list:
        ...
        if annex:
            ...
            original_url = []
            for ann in annex:
                file_url = upload_file_by_url(ann, "zhejiang", 'png')
                # file_url = 111
...
# zhongxinjinrongzhejiang_gzh(111, 222)
