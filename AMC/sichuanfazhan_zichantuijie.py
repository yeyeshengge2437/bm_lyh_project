...
def sichuanfazhan_zichantuijie(queue_id, webpage_id):
    page = ChromiumPage(co)
    page.set.load_mode.none()
    try:
        count = 1
        while True:
            page_url = f'http://www.scdamc.com/zhichantuijian/p{count}.html'
...
# sichuanfazhan_zichantuijie(111, 222)
