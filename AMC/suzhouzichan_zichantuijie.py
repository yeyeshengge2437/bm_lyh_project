...
def get_suzhouzichan_zichantuijie(queue_id, webpage_id):
    ...
    try:
        for count in range(1):
            ...
            page_url = f'https://www.sz-amc.com/business/recommend/list'
            response = requests.get(page_url, headers=headers, params=params)
            res = response.json()
            title_list = res["list"]
            img_set = set()
            name = '苏州资产管理有限公司_资产推介'
            title_set = judge_title_repeat(name)
            for title in title_list:
                title_name = title["noticeTitle"]
                ...
                if title_date:
                    ...
                    title_date = ''
                title_url = f"https://www.sz-amc.com/index/newsInfo?articleId={title['noticeId']}"
                ...
                # if 1:
                    ...
                    # print(title_name, title_url, files, original_url)
                    # return
                    # 上传到测试数据库
...
# get_suzhouzichan_zichantuijie(111, 222)
