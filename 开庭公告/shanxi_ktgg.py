    ...
    for page_num in range(1, page_court + 1):
        ...
        for item in value.get('data'):
            ...
            try:
                ...
                # 将数据插入到表中
                insert_sql = "INSERT INTO col_case_open (case_no,  court,  open_time, court_room, content, department,  origin, origin_domain, create_time, create_date, from_queue, webpage_id) VALUES (%s,%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

                cursor_test.execute(insert_sql, (
                    case_no, court, open_time, court_room, content,
                    department,
                    origin,
